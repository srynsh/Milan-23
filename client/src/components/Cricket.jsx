  ...
  return (
    <div className='rounded-3xl livescore-sports-box w-5/6 mx-auto my-4 flex flex-col justify-center items-center p-4'>
        ...
        <div className="flex justify-around items-center w-full Parkinson text-black m-2">
          <div className='rounded-full bg-white shadow-md shadow-[#00000078] text-2xl m-2 h-16 flex justify-center items-center p-2'>
            {parse.score1}/{parse.wicket1}<span className='text-xl text-[#000000aa]'>({parse.over1})</span>
          </div>
          <div className='rounded-full bg-white shadow-md shadow-[#00000078] text-3xl m-2 h-16 flex justify-center items-center p-2'>
          {parse.score2}/{parse.wicket2}<span className='text-xl text-[#000000aa]'>({parse.over2})</span>
          </div>
        </div>
    </div>
  )
