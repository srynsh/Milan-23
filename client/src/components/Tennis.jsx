...
export const Tennis = (parse) => {
    function returnScore(singleScore){
        return(
            <div className='rounded-full bg-white shadow-md shadow-[#00000078] md:text-xl m-2 w-6 h-6 md:w-8 md:h-8 flex justify-center items-center p-2 text-black'>
            {singleScore}
            </div>
        )
    }
