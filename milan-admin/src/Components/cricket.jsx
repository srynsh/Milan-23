...
function Cricket({ id, team1, team2, score1, score2, wicket1, wicket2, over1, over2 }) {
      ...
      <button style={{position: 'absolute', right: 0, top: 0}} onClick={removematch}>Remove Match</button>
            ...
            <div style={{ display: 'flex' }}>
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                    <div>{team1}</div>
                    <div style={{ display: 'flex' }}>
                        <input type="number" value={updatescore1} onChange={(e) => { settupdatescore1(e.target.value) }} /> / 
                        <input type="number" value={updatewicket1} onChange={(e) => { settupdatewicket1(e.target.value) }} />
                    </div>
                    <input type="number" value={updateover1} onChange={(e) => { setupdateover1(e.target.value) }} />
                </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                    ...
                    <div style={{ display: 'flex' }}>
                        ...
                        <input type="number" value={updatewicket2} onChange={(e) => { settupdatewicket2(e.target.value) }}  />
                    </div>
                    <input type="number" value={updateover2} onChange={(e) => { setupdateover2(e.target.value) }} />
                </div>
            </div>
